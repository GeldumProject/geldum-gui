#!/bin/bash
MONERO_URL=https://github.com/geldumproject/geldum.git
...
MONERO_DIR=$ROOT_DIR/geldum
BUILD_LIBWALLET=false

git clone https://github.com/geldumproject/geldum.git $MONERO_DIR
...
# Build libwallet if no previous version file exists
    ...
    echo "geldum/version.h not found - Building libwallet"
    BUILD_LIBWALLET=true
