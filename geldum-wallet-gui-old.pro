...
WALLET_ROOT=$$PWD/geldum

CONFIG += c++11

# cleaning "auto-generated" geldum directory on "make distclean"
...
linux {
   ...
   #     }
    ...
    # currently geldum has an issue with "static" build and linunwind-dev,
...
DISTFILES += \
    notes.txt \
    geldum/src/wallet/CMakeLists.txt \
